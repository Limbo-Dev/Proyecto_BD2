...
CREATE PROCEDURE INSERTAR_AUTO @NUMPLACA NCHAR(6), @MARCA NCHAR(100), @DISTRIBUIDOR INT, 
	@TIPO_MOTOR NCHAR(100), @TIPO_VEHICULO NCHAR(100), @AUTO_ANIO INT, @PRECIO_ALQUILER DECIMAL(3,2)
AS
BEGIN
...
CREATE PROCEDURE ACTUALIZAR_AUTO @NUMPLACA NCHAR(6), @MARCA NCHAR(100), @DISTRIBUIDOR INT,
	@TIPO_MOTOR NCHAR(100), @TIPO_VEHICULO NCHAR(10), @AUTO_ANIO INT, @PRECIO_ALQUILER DECIMAL(3,2)
AS 
BEGIN
